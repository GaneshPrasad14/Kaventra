  ...
  head: () => ({
    meta: [
      { title: "Contact — Kaventra Global Traders" },
      {
        name: "description",
        content:
          "Let's talk about your sourcing requirements. Chennai, Tamil Nadu · ajinthsnowson@kaventraglobal.com",
      },
            ...
            <div>
              ...
              <div className="mt-4 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <a
                    href="mailto:ajinthsnowson@kaventraglobal.com"
              ...
              >
                <div className="grid gap-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="group mt-2 inline-flex w-full items-center justify-center gap-2 rounded-full bg-primary px-6 py-4 text-sm font-semibold text-primary-foreground transition-colors hover:bg-ink-2 disabled:opacity-70 sm:w-auto sm:self-start"
                  >
