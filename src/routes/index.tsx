...
const badges = [
  ...
  { name: "ISO 22000", note: "Compliant systems", img: isoImg },
];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-x relative flex min-h-[92vh] flex-col justify-between pb-14 pt-32 text-bone md:pb-20 md:pt-40">
          ...
          <div className="mt-16 grid grid-cols-2 gap-x-6 gap-y-6 border-t border-white/15 pt-8 text-bone/80 md:grid-cols-4">
            {[
              { k: "5", v: "Product families" },
              { k: "4", v: "Continents served" },
              { k: "100%", v: "Lab-tested lots" },
              { k: "1 MT", v: "Minimum order" },
            ].map((s) => (
              <div key={s.v}>
                <p className="font-display text-4xl text-bone md:text-5xl">{s.k}</p>
